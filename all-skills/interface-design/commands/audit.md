...
2. **Depth violations**
   - Borders-only system É≈' flag shadows
   - Subtle system É≈' flag layered shadows
   - Allow ring shadows (0 0 0 1px)

3. **Color violations**
   - If palette defined É≈' flag colors not in palette
...
1. Build UI É≈' establish system automatically
2. Run /extract É≈' create system from existing code
```
