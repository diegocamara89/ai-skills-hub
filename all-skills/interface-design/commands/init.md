...
description: Build UI with craft and consistency. For interface design (dashboards, apps, tools) ƒ?" not marketing sites.
---

## Required Reading ƒ?" Do This First

Before writing any code, read this file completely:

1. `../skills/interface-design/SKILL.md` ƒ?" the foundation, principles, craft knowledge, and checks
...
## Intent First ƒ?" Answer Before Building
...
Palette: [foundation + accent ƒ?" and WHY these colors fit the product's world]
Depth: [borders / subtle shadows / layered ƒ?" and WHY]
Surfaces: [your elevation scale ƒ?" and WHY this temperature]
Typography: [your typeface choice ƒ?" and WHY it fits the intent]
Spacing: [your base unit]
```

Every choice must be explainable. If your answer is "it's common" or "it works" ƒ?" you haven't chosen. You've defaulted.
...
1. Read the required files above (always ƒ?" even if system.md exists)
...
Always offer ƒ?" new patterns should be captured whether system.md exists or not.
